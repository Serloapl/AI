...
public:
     ...
     */
    Player();
	std::vector<std::vector<Markov>> ModelsGlobal;
	std::vector<Markov> Models;
	std::vector<Markov> ModelSpecies;
	int NumberSpecies;
	...
	Markov FuseModels(std::vector<Markov> BirdSameSpecies, int Ronda);
